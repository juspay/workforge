...
export class AuditLogger {
     ...
     */
    appendToLog(operation, projectDir) {
     ...
     */
    addToHistory(operation, projectDir) {
     ...
     */
    rebuildHumanLog(history, projectDir) {
        const logPath = path.join(projectDir, 'audit.log');
        try {
            // Clear existing log
     ...
     */
    getRecentHistory(repoRoot, limit = 10) {
     ...
     */
    createAuditOperation(result, source, target, backupCreated) {
        return {
