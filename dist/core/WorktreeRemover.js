...
export class WorktreeRemover {
     ...
     */
    async remove(worktree, force = false) {
        ...
        if (!exists && !force) {
            return {
                success: false,
                message: 'Worktree directory does not exist. Use git worktree prune to clean up, or use --force.'
            };
        }
...
//# sourceMappingURL=WorktreeRemover.js.map