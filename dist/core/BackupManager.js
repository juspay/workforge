...
export class BackupManager {
     ...
     * @returns Number of backups deleted
     */
    deleteBackupsOlderThan(repoRoot, olderThan) {
        const backups = this.listBackups(repoRoot);
        let deletedCount = 0;
        for (const backup of backups) {
