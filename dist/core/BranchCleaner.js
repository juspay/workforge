...
export class BranchCleaner {
     ...
     */
    async cleanup(branchName, repoRoot, safety, force = false) {
        const warnings = [];
        ...
        if (errorMessage.includes('not fully merged')) {
            return {
                success: false,
                message: 'Branch is not fully merged. Use --force to delete anyway, or merge the branch first.',
                warnings
            };
        }
     ...
     * @returns Result object with success status and message
     */
    async deleteRemote(branchName, repoRoot, remoteName = 'origin') {
     ...
     */
    canSafelyDelete(branchName, repoRoot) {
        // Check against main
     ...
     */
    getDeletionStrategy(safety, force) {
     ...
     */
    getRelatedBranches(branchName, repoRoot) {
        const related = {
            local: false,
            remote: []
        };
...
//# sourceMappingURL=BranchCleaner.js.map