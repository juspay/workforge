...
export class EnvSyncer {
     ...
     */
    async sync(sourcePath, targetPath, diff, decision) {
        const result = {
            success: false,
            backupCreated: false,
            addedCount: 0,
     ...
     */
    mergeVariables(targetVars, diff, decision) {
     ...
     */
    validateDecision(diff, decision) {
        const errors = [];
        // Validate added keys
...
//# sourceMappingURL=EnvSyncer.js.map